...
INSERT INTO InsurancePackage (class, startDate, endDate, cost, insuranceCompany)
VALUES ( 'small', TIMESTAMP('2016-01-01'),TIMESTAMP('2016-06-01'),200,'McNab Insurance');

INSERT INTO InsurancePackage (class, startDate, endDate, cost, insuranceCompany)
VALUES ( 'limo', TIMESTAMP('2015-09-22'),TIMESTAMP('2016-09-22'),1000,'McNab Insurance');

INSERT INTO InsurancePackage (class, startDate, endDate, cost, insuranceCompany)
VALUES ( 'luxury', TIMESTAMP('2016-01-01'),TIMESTAMP('2016-06-01'),600,'McNab Insurance');

INSERT INTO InsurancePackage (class, startDate, endDate, cost, insuranceCompany)
VALUES ( 'large', TIMESTAMP('2015-02-01'),TIMESTAMP('2016-04-01'),1200,'Billy Bob Insurance');

INSERT INTO InsurancePackage (class,  startDate, endDate, cost, insuranceCompany)
VALUES ('small', TIMESTAMP('2016-02-12'),TIMESTAMP('2016-09-11'),1729,'Hugh Jasshole Insurance');





INSERT INTO Employee ( name, salary, responsibilities)
...
INSERT INTO Station ( longitude, latitude)
...
INSERT INTO User (name, email, ccNumber)
...
INSERT INTO Subscription ( monthlyPrice, class, startDate, endDate,uid)
VALUES ( 60, 'small','2015-01-01', '2016-01-01',1);

INSERT INTO Subscription ( monthlyPrice, class, startDate, endDate,uid)
VALUES ( 100, 'big','2016-01-01', '2017-01-01',2);

INSERT INTO Subscription ( monthlyPrice, class, startDate, endDate,uid)
VALUES ( 70, 'small','2016-01-01', '2016-02-01',3);

INSERT INTO Subscription ( monthlyPrice, class, startDate, endDate,uid)
VALUES ( 200, 'limo','2015-07-14', '2016-03-14',4);

INSERT INTO Subscription ( monthlyPrice, class, startDate, endDate,uid)
VALUES ( 50, 'small','2016-02-22', '2017-08-22',5);

INSERT INTO Ride (startLatitude, startLongitude, destinationLatitude, destinationlongitude, startTime, endTime, price,cid)
VALUES ( 45.504115, -73.574314, 45.507774, -73.562699, '2015-11-10-12.20.21.02', '2015-11-10-12.30.45.32',5.67,1);

INSERT INTO Ride ( startLatitude, startLongitude, destinationLatitude, destinationlongitude, startTime, endTime, price,cid)
VALUES ( 45.508433, -73.568844, 45.448116, -73.698170, '2016-01-10-01.13.23.46', '2016-01-10-01.50.34.21',40.75,3);

INSERT INTO Ride ( startLatitude, startLongitude, destinationLatitude, destinationlongitude, startTime,cid)
VALUES ( 45.510852, -73.577279, 45.499233, -73.647537, '2016-02-27-23.55.55.55',3);

INSERT INTO Ride ( startLatitude, startLongitude, destinationLatitude, destinationlongitude, startTime, endTime, price,cid)
VALUES ( 45.470336, -73.603934, 45.473856, -73.607902, '2015-07-04-16.15.14.13', '2015-07-04-16.15.14.13', 17.29,2);

INSERT INTO Ride ( startLatitude, startLongitude, destinationLatitude, destinationlongitude, startTime, endTime, price,cid)
VALUES (45.493828, -73.575208, 45.513820, -73.557249, '2016-01-01-17.34.33.03', '2016-01-02-13.53.45.22',38.99,3);
